...
export class DriverService {
  private apiUrl = 'http://localhost:7223/api/driver';
  ...
  assignUserToDriver(driverId: string, userId: string) {
    return this.http.patch(`${this.apiUrl}/${driverId}/assign-user`, { userId }, {
      headers: this.getAuthHeaders()
    });
  }
} 